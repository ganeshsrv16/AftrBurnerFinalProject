...
#include <vector>
#include <memory>
#include "GLViewGaneshFinalProject.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewGaneshFinalProject > glView( Aftr::GLViewGaneshFinalProject::New( args ) );
